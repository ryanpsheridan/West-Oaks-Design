...
- `public/images/gallery/` — every image is a generated illustration, not a
  photo, and every project location in the gallery is invented.
...
- The placeholder illustrations are generated by
  `scripts/generate-placeholders.mjs`. Delete the script and its output
  together once real photography lands.
