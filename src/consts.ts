...
// The business is new. This feeds the schema's foundingDate, and nothing
// else: there is deliberately no "years in business" or "projects completed"
// figure anywhere on the site, because there aren't any yet and inventing
// them is the fastest way to lose the trust the whole site is built to earn.
// TODO: confirm the real founding year.
...
export const NAV_CTA = { label: 'Start your project', href: '/contact/#project' };
